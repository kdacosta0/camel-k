...
require (
	...
	github.com/apache/camel-k/pkg/apis/camel v1.6.4
	github.com/apache/camel-k/pkg/client/camel v1.6.4
	github.com/apache/camel-k/pkg/kamelet/repository v1.6.4
